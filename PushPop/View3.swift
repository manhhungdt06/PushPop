...
class View3: UIViewController {
    ...
    @IBAction func action_PopV3(_ sender: AnyObject) {
        let dashboardVC = navigationController!.viewControllers.filter { $0 is View2 }.first!
    ...
    func setRandom() {
        ...
        // let randomPosition = Int(arc4random_uniform(3))+1
